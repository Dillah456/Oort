...
<html lang="en">
    <head>
        ...
        <!-- CSS SB Admin, pastikan folder ini ada di public/sbadmin/dist/css/styles.css -->
    ...
    <body class="sb-nav-fixed">
        ...
        <!-- JS SB Admin, pastikan file-file ini ada di folder yang sama -->
        ...
        <script src="/sbadmin/dist/js/datatables-simple-demo.js"></script>
    </body>
</html>
